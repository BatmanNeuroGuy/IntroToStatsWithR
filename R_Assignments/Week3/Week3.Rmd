...
Conditional probability, independence, mutual exclusivity, Bayesian updating. We did not learn about comparing disparate probability distributions, one empirically sampled and one simulated, in order to make an inference about the independence (or lack thereof) of two events. So far we have not discussed this strategy directly, although it is related to bootstrapping which we discussed in the previous unit. So in a sense, yes, we have discussed this, I suppose.
<div id="license">
